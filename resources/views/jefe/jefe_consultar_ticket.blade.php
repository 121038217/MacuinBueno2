...
<div class="flex justify-center mt-5 mb-5">Rellenar todos los campos (obligatorio)</div>
<!--Tabla-->
    ...
    <table class="table-auto w-full text-sm text-left" style="width: 100px;" >
      ...
      <tbody class="bg-white">
        <tr>
          ...
          <th class="px-4 py-2"><button onclick="Comentarios()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded transition-colors duration-300 mt-4 ">Comentarios</button></th>
        </tr>
        </tbody>
    </table>
    <div class="flex justify-center mt-10">Macuin DashBoards. Todos los derechos Reservados</div>
  </div>
</div>
<script>
