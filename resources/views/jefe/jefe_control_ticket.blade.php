...
<body class="p-4">
    <div class="mt-20 mx-auto mb-24 mr-10 ml-10">
        <h1 class="text-center text-3xl font-bold mb-5">Control Tickets</h1>
        <h2 class="text-center text-3xl font-bold mb-5">Solicitud de Ticket</h1>
            ...
            <table class="w-full table-auto">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Asignar</th>
                    </tr>
                </thead>
                    ...
                    <tr>
                        ...
                        <td class="px-2 py-2 whitespace-nowrap">
                            <select class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
                                <option value="default">Seleccionar Auxiliar</option>
                                <option value="usuario_1">Nana Pancha</option>
                                <option value="usuario_2">Panfilo Benitez</option>
                                <option value="usuario_3">Bob Esponja</option>
                                <option value="usuario_4">Till Lindemann</option>
                            </select>
                        </td>
                    </tr>
                </tbody>
        ...
        <h2 class="text-center text-3xl font-bold mt-5 mb-5">tickets Asignados</h1>
        <div class="overflow-x-auto">
            <table class="w-full table-auto">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Clasificación</th>
                        <th class="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Detalle</th>
                        <th class="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Auxiliar</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <tr>
                        ...
                        <td class="px-2 py-2 whitespace-nowrap">Problemas de red</td>
                        <td class="px-2 py-2 whitespace-nowrap">Conexión intermitente</td>
                        <td class="px-2 py-2 whitespace-nowrap">Nana Pancha</td>
                        <td class="px-2 py-2 whitespace-nowrap">
                            <select class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
    ...
    <div class="mt-10 text-center">
        ...
        <a href="/consultar_ticket" class="py-2 px-4 bg-indigo-600 text-white rounded-md shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 ml-4">Buscar Ticket</a>
    </div>
